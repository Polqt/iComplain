...
export const priorityIdMap: Record<string, number> = {
	low: 1,
	medium: 2,
	high: 3,
	urgent: 4,
...
export function getAgingDays(createdAt: string): number {
...
export function getPriorityBgColor(priorityKey: string): string {
	switch (priorityKey) {
		case "high":
		case "urgent":
...
export function getPriorityBadgeColor(priorityKey: string): string {
...
export function getPriorityKey(
	priority: TicketPriority | string | any,
): PriorityKey {
	...
	if (typeof priority === "object") {
		const name = priority.name
			? String(priority.name).toLowerCase()
			: undefined;
...
export const columns: {
...
}[] = [
	{
		...
		dot: "bg-amber-400",
		headerTint:
			"bg-base-200 border-base-content/10 border-l-2 border-l-amber-400",
	...
	},
	{
		...
		dot: "bg-sky-400",
		headerTint:
			"bg-base-200 border-base-content/10 border-l-2 border-l-sky-400",
	...
	},
	{
		...
		dot: "bg-emerald-400",
		headerTint:
			"bg-base-200 border-base-content/10 border-l-2 border-l-emerald-400",
	...
	},
	{
		...
		headerTint:
			"bg-base-200 border-base-content/10 border-l-2 border-l-base-content/25",
...
export const categoriesFilters: { id: string; name: string }[] = [
	...
	{
		id: "cleanliness & waste management",
		name: "Cleanliness & Waste Management",
	},
	{
		id: "infrastructure & building maintenance",
		name: "Infrastructure & Building Maintenance",
	},
