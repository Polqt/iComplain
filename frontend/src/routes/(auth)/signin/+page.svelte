...
<div class="w-full">
  ...
  <!-- Error Alert -->
  {#if generalError}
    <div class="alert bg-error/10 border border-error/20 text-error mb-6 rounded-xl py-3">
  ...
  >
    ...
    <div class="form-control">
      <label for="signin-password" class="label pb-2">
        <span class="label-text font-semibold text-base-content text-sm">Password</span>
      </label>
      <div class="relative">
        <div
          class="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none text-base-content/40"
    ...
    <div class="mt-6 space-y-4">
      <div class="relative flex items-center justify-center">
        ...
        <div class="relative px-4 bg-base-100">
          <span class="text-xs font-medium text-base-content/50 uppercase tracking-wider">Or continue with</span>
        </div>
      </div>
      <button
        type="button"
